...
⚠️ This package is **abandoned** and no longer maintained. The author suggests using the **[rinvex/laravel-subscriptions](https://github.com/rinvex/laravel-subscriptions)** package instead. ⚠️
